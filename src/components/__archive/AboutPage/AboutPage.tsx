  ...
  return (
    <div className={styles.about}>
      ...
      <p className={styles.message}>
        ...
        typography and animation. I aim to cover all of these topics and more in
        upcoming blog posts and tutorials, and hope they provide a good resource
        for up and coming developers wanting to hone their skills.
      </p>
      <p className={styles.message}>
